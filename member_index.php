                        ...
                        <div class="col-xl-12 col-lg-8">
                            <div class="card shadow mb-4">
                                <div class="card border-left-danger shadow h-100">
                                    ...
                                    <h6 class="m-0 font-weight-bold text-danger">DAFTAR ANGGOTA</h6>
                                    </div>
                                    <div class="card-body">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><?=$row['tgl_join']?></td>
                                                            <td>
                                                                <a class="btn btn-success" href="member_edit.php?idedit=<?=$row['id']?>">Edit</a>
                                                                <a class="btn btn-danger" href="member_delete.php?iddel=<?=$row['id']?>"
                                                                onclick="if(!confirm('Anda Yakin Ingin Menghapus Data member <?=$row['nama']?>?')) {return false}"
                                                                >Delete</a>
                                                            </td>
                                                          </tr>
                                                          <?php 
                                                      ...
                                                      <br>
                                                      <div class="container">
                                                        <a class="btn btn-danger" href="member_form.php">Create New Data</a>
                                                      </div>
                                                </div>
                                            </div>
                                        </div>
