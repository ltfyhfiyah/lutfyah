                            ...
                            <div class="card shadow mb-4">
                                <div class="card border-left-warning shadow h-100">
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-warning">TAMBAH PEMINJAMAN</h6>
                                    </div>
                                    <div class="card-body">
                                                ...
                                                <div class="font-weight-bold text-warning mb-1">
                                                    <form class="form" method="post" action="peminjaman_proses.php">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="date" id="tgl_peminjaman" name="tgl_peminjaman" class="form-control">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-10 offset-sm-2">
                                                                <input type="submit" name="proses" value="Simpan" class="btn btn-warning">
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
