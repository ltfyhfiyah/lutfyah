...
$_idedit = $_GET['idedit'];
if (!empty($_idedit)) {
    $sql_id_member = "SELECT id FROM member";
    $result_id_member = $dbh->query($sql_id_member);
    $sql_id_buku = "SELECT id FROM buku";
    $result_id_buku = $dbh->query($sql_id_buku);
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="peminjaman_index.php">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card border-left-warning shadow h-100">
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-warning">EDIT PEMINJAMAN</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="font-weight-bold text-warning mb-1">
                                                    <form class="form" method="post" action="peminjaman_proses.php">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select id="id_member" name="id_member" required="required" class="form-control">
                                                                    <option disabled selected>Pilih ID Member</option>
                                                                    <?php
                                                                        while ($row = $result_id_member->fetch(PDO::FETCH_ASSOC)) {
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select id="id_buku" name="id_buku" required="required" class="form-control">
                                                                    <option disabled selected>Pilih ID Buku</option>
                                                                    <?php
                                                                        while ($row = $result_id_buku->fetch(PDO::FETCH_ASSOC)) {
                                                                            echo "<option value='" . $row['id'] . "'>" . $row['id'] . "</option>";
                                                                        }
                                                                    ?>
                                                                </select>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="date" id="tgl_peminjaman" name="tgl_peminjaman" class="form-control" value="<?= $row['tgl_peminjaman'] ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="date" id="tgl_pengembalian" name="tgl_pengembalian" class="form-control"  value="<?= $row['tgl_pengembalian'] ?>">
                                                            </div>
                                                        </div>
