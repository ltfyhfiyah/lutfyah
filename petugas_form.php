                            ...
                            <div class="card shadow mb-4">
                                <div class="card border-left-secondary shadow h-100">
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-secondary">TAMBAH PETUGAS</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="font-weight-bold text-secondary mb-1">
                                                    <form class="form" method="post" action="petugas_proses.php">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select id="jabatan" name="jabatan" class="form-control">
                                                                    ...
                                                                    <option value="Kustos Arsip">Kustos Arsip</option>
                                                                    <option value="Kustos Arsip">Kustos Arsip</option>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-10 offset-sm-2">
                                                                <input type="submit" name="proses" value="Simpan" class="btn btn-secondary">
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
