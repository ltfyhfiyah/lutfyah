                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><?=$row['deskripsi']?></td>
                                                            <td>
                                                                <a class="btn btn-success" href="buku_edit.php?idedit=<?=$row['id']?>">Edit</a>
                                                                <a class="btn btn-danger" href="buku_delete.php?iddel=<?=$row['id']?>"
                                                                onclick="if(!confirm('Anda Yakin Ingin Menghapus Data Buku <?=$row['judul']?>?')) {return false}"
                                                                >Delete</a>
                                                            </td>
                                                          </tr>
                                                          <?php 
                                                      ...
                                                      <br>
                                                      <div class="container">
                                                        <a class="btn btn-primary" href="buku_form.php">Create New Data</a>
                                                      </div>
                                                </div>
                                            </div>
                                        </div>
