                        ...
                        <div class="col-xl-12 col-lg-8">
                            <div class="card shadow mb-4">
                                <div class="card border-left-warning shadow h-100">
                                    ...
                                    <h6 class="m-0 font-weight-bold text-warning">DAFTAR PEMINJAMAN</h6>
                                    </div>
                                    <div class="card-body">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-success" href="peminjaman_edit.php?idedit=<?=$row['id']?>">Edit</a>
                                                                <a class="btn btn-danger" href="peminjaman_delete.php?iddel=<?=$row['id']?>"
                                                                onclick="if(!confirm('Anda Yakin Ingin Menghapus Data peminjaman <?=$row['id_member']?>?')) {return false}"
                                                                >Delete</a>
                                                            </td>
                                                          </tr>
                                                          <?php 
                                                      ...
                                                      <br>
                                                      <div class="container">
                                                        <a class="btn btn-warning" href="peminjaman_form.php">Create New Data</a>
                                                      </div>
                                                </div>
                                            </div>
                                        </div>
