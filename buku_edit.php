...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="buku_index.php">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="font-weight-bold text-primary mb-1">
                                                    <form class="form" method="post" action="buku_proses.php">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" id="penulis" name="penulis" class="form-control" value="<?= $row['penulis'] ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" id="penerbit" name="penerbit" class="form-control" value="<?= $row['penerbit'] ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" id="tahun_terbit" name="tahun_terbit" class="form-control"  value="<?= $row['tahun_terbit'] ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea type="text" id="deskripsi" name="deskripsi" class="form-control"><?= $row['deskripsi'] ?></textarea>
                                                            </div>
                                                        </div>
