...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="petugas_index.php">
                        ...
                        <div class="col-xl-12 col-lg-8">
                            <div class="card shadow mb-4">
                                <div class="card border-left-secondary shadow h-100">
                                    ...
                                    <h6 class="m-0 font-weight-bold text-secondary">DAFTAR PETUGAS</h6>
                                    </div>
                                    <div class="card-body">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><?=$row['jabatan']?></td>
                                                            <td>
                                                                <a class="btn btn-success" href="petugas_edit.php?idedit=<?=$row['id']?>">Edit</a>
                                                                <a class="btn btn-danger" href="petugas_delete.php?iddel=<?=$row['id']?>"
                                                                onclick="if(!confirm('Anda Yakin Ingin Menghapus Data petugas <?=$row['nama']?>?')) {return false}"
                                                                >Delete</a>
                                                            </td>
                                                          </tr>
                                                          <?php 
                                                      ...
                                                      <br>
                                                      <div class="container">
                                                        <a class="btn btn-secondary" href="petugas_form.php">Create New Data</a>
                                                      </div>
                                                </div>
                                            </div>
                                        </div>
