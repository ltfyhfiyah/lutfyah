...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="anggota_index.php">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card border-left-danger shadow h-100">
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-danger">TAMBAH ANGGOTA</h6>
                                    </div>
                                    <div class="card-body">
                                                    ...
                                                    <form class="form" method="post" action="member_proses.php">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-10 offset-sm-2">
                                                                <input type="submit" name="proses" value="Simpan" class="btn btn-danger">
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
